...
//*******************************使用说明***************************************
//使用说明：
//       AdViewpager   adViewpagerUtil = new AdViewpager(getAppContext(), viewPagerTop, dotLayout, urls);
//adViewpagerUtil.setOnAdItemClickListener(new AdViewpager.OnAdItemClickListener(){
//@Override
...
public class AdViewpager {
     ...
     * @param urls
     */
    public AdViewpager(Context context, ViewPager viewPager, String[] urls) {
     ...
     * @param urls
     */
    public AdViewpager(Context context, ViewPager viewPager, LinearLayout dotlayout, int dotsize, int dotoffset, String[] urls) {
        this.context = context;
        this.viewPager = viewPager;
    ...
    public AdViewpager(Context context, ViewPager viewPager, LinearLayout dotlayout, String[] urls) {
        this.context = context;
        this.viewPager = viewPager;
        this.dotlayout = dotlayout;
        this.urls = urls;
        ...
        if (urls.length > 0) {
            ...
            for (int i = 0; i < length; i++) {
                if (i < length - 2) {
                    ...
                    ImageUtils.display(mImageViews[i + 1], url);
            ...
            ImageUtils.display(mImageViews[0], urls[urls.length - 1]);
            ImageUtils.display(mImageViews[length - 1], urls[0]);
        }
    }
